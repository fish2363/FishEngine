...
public class ChatManager : MonoBehaviour
{
    ...
    private string[] chat = { "", "좌측 상단에는 별의 총 개수가 표시됩니다","좌클릭을 눌러 별을 발사해 보세요","가지고 있는 별의 개수에 따라 보이는 블록이 달라요", "저는 통과할 수 없지만 별은 통과할 수 있는 블럭이에요" , "점프와 동시에 별을 던지는 건 어떤가요?","별을 위로 던지면서 지나가요!", "구멍 사이에 별을 던져두고 포탈로 가요", "머리위로 별을 던지면서 지나가죠?"};
